...
public class GraphEdge implements Comparable<Object> {
    ...
    /**
     * This constructor is used to create new edges for use with the path
     * finding algorithms Dijkstra and A* <br>
     * <b>It should not be used directly. </b>
     * 
     * @param edge
     *            the existing edge
     * @param costSoFar
     *            the cost to the destination node so far.
     */
    ...
    /**
     * Create an edge from 2 existing nodes. If the cost is 0.0 then calculate
     * the cost based on the physical distance between the nodes. <br>
     * 
     * @param from
     *            'from' node
     * @param to
