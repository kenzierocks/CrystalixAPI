...
/**
 * A Star <br>
 * Objects of this class are used to search a graph and find a path between two
 * nodes using this algorithm.
 * 
 * @author Peter Lager
 *
 */
public class GraphSearch_Astar implements IGraphSearch {
    ...
    /**
     * The settled nodes - the nodes whose shortest distances from the source
     * have been found.
     */
    ...
    /**
     * Indicates the predecessor node for a given node. This is used to store
     * the shortest path. <node of interest, node where the edge originated>
     */
    ...
    /**
     * Stores the smallest full cost (path cost + heuristic cost) found so far
     * for a given node.
     */
    ...
    /**
     * Clears all data related to a search so this object can be reused for
     * another search
     */
    private void clear() {
     ...
     * This will return a linkedlist of the nodes that make up the route from
     * start to end order. <br>
     * If either the start or target node does not exist or if a route can't be
     ...
     *            id of the target node
     * @param remember
     *            whether to remember the examined edges.
     * @return the route as a list of nodes
     */
    @Override
    public LinkedList<GraphNode> search(int startID, int targetID,
        ...
        while (!unsettledNodes.isEmpty()) {
            ...
            for (GraphEdge edge : nextEdges) {
                ...
                if (!settledNodes.contains(edgeTo)
                        && getFullCost(edgeTo) > gCost + hCost) {
    ...
    /**
     * Get the path found as an array of GraphNode(s) in start->end order <br>
     * 
    ...
    /**
     * Get the path found as an array of T(s) in start->end order. <br>
     * The type of each element in the array will be of type Object if the
    ...
    /**
     * Objects of this class are created as and when required by the path search
     * algorithm
     * 
     * @author Peter Lager
     *
