...
/**
 * This class represents a node (vertex) that can be used with the Graph class. <br>
 * 
 * The node has a position in 3D space for 2D applications the z value should be
 * zero. <br>
 * 
 ...
 * 
 * It is the responsibility of the user to ensure that each node ID is unique as
 * duplicate ID numbers can lead to unpredictable behaviour.
 * 
 * @author Peter Lager
 *
 */
public class GraphNode implements Comparable<Object> {
     ...
     * @param y
     * @param z
     *            set to 0 (zero for 2D applications
     */
